...
<div className="bg-black text-white p-8 py-20">
  ...
  <div className=" mb-8 flex justify-between  items-center">
    <div>
    <h2 className="text-6xl font-semibold">Innovation That Ensure</h2>
    <h2 className="text-6xl font-semibold text-orange-500">Your Market Success.</h2>
    </div>
  ...
  <div className="flex justify-center gap-6">
    {/* Branding Card */}
    <div className="bg-[#0c0808] p-6 w-1/4 rounded-md flex justify-between flex-col">
      <h3 className="text-3xl font-semibold mb-4">Branding</h3>
    ...
    {/* Product Design Card */}
    <div className="bg-[#0c0808] p-6 w-1/4 h-[350px] rounded-md flex flex-col justify-between">
      <h3 className="text-3xl font-semibold mb-4">Product Design</h3>
    ...
    <div className="bg-[#0c0808] p-6 w-1/4 rounded-md flex justify-between flex-col">
      <h3 className="text-3xl font-semibold mb-4">Software Development</h3>
    ...
    <div className="bg-[#0c0808] p-6 w-1/4 rounded-md flex flex-col justify-between">
      <h3 className="text-3xl font-semibold mb-4">Digital Marketing</h3>
