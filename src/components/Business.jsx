...
export const Business = () => {
  return (
    <section className="section bg-black 2lg:px-20 sm:px-10 px-5 flex flex-col justify-center 2lg:h-screen py-5 2lg:py-0">
      ...
      <div className="w-full flex justify-end items-center 2xl:py-10 xxm:py-5 pb-5 xxm:border-b-[1px] border-[#1C1C21]">
        <div className="flex xxm:gap-5 gap-2.5 items-center">
          ...
          <div className="flex items-center rounded-full lg:h-16 lg:w-[124px] xxm:h-14 h-[41px] xxm:w-[105px] w-[90px] border-[1px] border-dark-1 xxm:p-2 px-[3.1px] justify-between">
            <button className="border-0 outline-none bg-[#212127] rounded-full lg:w-12 lg:h-12 xxm:w-10 xxm:h-10 w-8 h-8 flex justify-center items-center transition-colors ease-out duration-200 text-[#4E4E4E] hover:bg-[#161616]">
              <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 512 512" className="xxm:w-auto w-[22px]" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="swiper-container flex flex-wrap gap-4 justify-center lg:justify-start mt-5">
        <Card />
        <Card />
        <Card />
      </div>
